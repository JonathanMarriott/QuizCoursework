...
function titleFinish(quizData) {
    $("#titleDiv").html('<h4 class="font-weight-normal text-light">Quiz Title: ' + quizData.title + '</h4>') // Replaces the title form with the submitted title
    ...
    $("#formDiv").html('<h4 class="font-weight-normal text-light">Add a question</h4>' +
        ...
        '                            <input type="text" id="inputAnswer1" name="question" class="form-control" placeholder="Enter Answer 1" required>\n' +
        '                        </div>\n' +
        '                        <div class="form-check form-check-inline col-3 mx-3">\n' +
        '                            <input type="checkbox" class="form-check-input" id="ansCheck1"><!--Users selects if answer is correct-->\n' +
        ...
        '                            <input type="text" id="inputAnswer2" name="question" class="form-control" placeholder="Enter Answer 2" required>\n' +
        '                        </div>\n' +
        '                        <div class="form-check form-check-inline col-3 mx-3">\n' +
        '                            <input type="checkbox" class="form-check-input" id="ansCheck2">\n' +
        ...
        '                            <input type="text" id="inputAnswer3" name="question" class="form-control" placeholder="Enter Answer 3" required>\n' +
        '                        </div>\n' +
        '                        <div class="form-check form-check-inline col-3 mx-3">\n' +
        '                            <input type="checkbox" class="form-check-input" id="ansCheck3">\n' +
        ...
        '                            <input type="text" id="inputAnswer4" name="question" class="form-control" placeholder="Enter Answer 4" required>\n' +
        '                        </div>\n' +
        '                        <div class="form-check form-check-inline col-3 mx-3">\n' +
        '                            <input type="checkbox" class="form-check-input" id="ansCheck4">\n' +
        ...
        '                        <input type="file" class="form-control-file font-weight-normal text-light" id="picture">\n' +
        '                    </div>\n' +
...
function questionForm(quizData){
    ...
    let formData = new FormData(this); //Constructs form data from the fields
